...
response = requests.get("https://api.openweathermap.org/data/2.5/weather?q={},{}&appid={}&units=metric".format(city,state_code, Api_Key))
...
expected_url = 'https://api.openweathermap.org/data/2.5/weather?q=karachi,PK-SD&appid=c73e48a7ec5a89f57f52c48a792e7064&units=metric'
